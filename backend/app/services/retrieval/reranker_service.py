...
class RerankerService:
    ...
    def search_and_rerank(
        ...
        t0 = time.time()
        bm25_results = bm25_service.search(query, top_k=recall_top_k, org_id=org_id)
        ...
        t0 = time.time()
        vector_results = milvus_service.search(query_embedding, top_k=recall_top_k, org_id=org_id)
